...
describe('MasterDetails Management Component', () => {
  let comp: MasterDetailsComponent;
  let fixture: ComponentFixture<MasterDetailsComponent>;
  let service: MasterDetailsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'master-details', component: MasterDetailsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(MasterDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.masterDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
